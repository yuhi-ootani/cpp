...
AForm::AForm() : _name("unnamed"), _signed(false), _gradeToSign(150), _gradeToExecute(150) {
    std::cout << "AFORM: default(unnamed, 150, 150) Form constructor called\n";
}

AForm::AForm(const AForm &other)
    : _name(other._name), _signed(other._signed), _gradeToSign(other._gradeToSign),
      _gradeToExecute(other._gradeToExecute) {
    std::cout << "AFORM: " << other._name << " Form copy-constructor called\n";
}
...
AForm &AForm::operator=(const AForm &other) {
    ...
    std::cout << "AFORM: Form assigment operator called. " << other._name
              << "'s signed status was only copied.💀\n";
    return *this;
}

AForm::~AForm() { std::cout << "AFORM: " << this->_name << " Form destructor called\n"; }
...
AForm::AForm(const std::string name, const int gradeToSign, const int GradeToExecute)
    ...
    std::cout << "AFORM: " << name << " Form constructor called\n";
}
